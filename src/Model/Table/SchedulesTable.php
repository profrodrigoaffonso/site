...
class SchedulesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('command_send')
            ->maxLength('command_send', 10)
            ->allowEmptyString('command_send');
        ...
        $validator
            ->scalar('specific_date')
            ->allowEmptyString('specific_date');

        $validator
            ->scalar('days_week')
            ->maxLength('days_week', 16)
            ->allowEmptyString('days_week');
